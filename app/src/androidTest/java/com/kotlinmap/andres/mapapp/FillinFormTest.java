...
public class FillinFormTest {
    ...
    @Rule
    public ActivityTestRule<FillinForm> mActivityTestRule = new ActivityTestRule<>(FillinForm.class);

    @Test
    public void fillinFormTest() {

        ViewInteraction appCompatEditText9 = onView(
                allOf(withId(R.id.edLocationName),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        appCompatEditText9.perform(replaceText("USA"), closeSoftKeyboard());


        ViewInteraction appCompatButton = onView(
                allOf(withId(R.id.btGoToMap), withText("Go to Map"),
                        childAtPosition(
                                childAtPosition(
